...
namespace CarService.API.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 12 запчастей — используем ArticleNumber (как в вашей модели Part)
            ...
            // 22 заказа — Status как enum OrderStatus
            ...
            // Запчасти в заказах — PriceAtOrder берём из цены запчасти
